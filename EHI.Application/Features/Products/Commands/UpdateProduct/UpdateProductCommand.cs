...
{
	public class UpdateProductCommand : IRequest<Customer>
	{
		...
		public class UpdateProductCommandHandler : IRequestHandler<UpdateProductCommand, Customer>
		{
			...
			public async Task<Customer> Handle(UpdateProductCommand command, CancellationToken cancellationToken)
			{
